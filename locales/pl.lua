...
Locales['pl'] = {
  ...
  ['threw_weapon_already'] = 'już posiadasz na sobie tę broń',
  ['threw_cannot_pickup'] = 'nie możesz tego podnieść gdyż twój ekwipunek jest pełen!',
  ...
  ['command_setjob_grade'] = 'stopień w pracy',
  ['command_setjob_invalid'] = 'praca, stopień lub obydwa są nieprawidłowe',
  ...
  ['component_clip_drum'] = 'bębnowy magazynek',
  ['component_clip_box'] = 'boksowy magazynek',
  ...
  -- Weapon Ammo
  ['ammo_rounds'] = 'naboi/ów',
  ['ammo_shells'] = 'pocisk(ów)',
  ['ammo_charge'] = 'naładowany',
  ['ammo_petrol'] = 'galon(ów) paliwa',
  ['ammo_firework'] = 'fajerwerka/ów',
  ['ammo_rockets'] = 'rakiet(a)',
  ['ammo_grenadelauncher'] = 'granat(ów)',
  ['ammo_grenade'] = 'granat(ów)',
  ['ammo_stickybomb'] = 'bomb(a)',
  ['ammo_pipebomb'] = 'bomb(a)',
  ['ammo_smokebomb'] = 'bomb(a)',
  ['ammo_molotov'] = 'kontail(ów)',
  ['ammo_proxmine'] = 'min(a)',
  ['ammo_bzgas'] = 'puszka/ek',
  ['ammo_ball'] = 'kul(a)',
  ['ammo_snowball'] = 'snieżka/ek',
  ['ammo_flare'] = 'flar(a)',
  ['ammo_flaregun'] = 'flar(a)',

  -- Weapon Tints
  ['tint_default'] = 'domyślna skórka',
  ['tint_green'] = 'zielona skórka',
  ['tint_gold'] = 'złota skórka',
  ['tint_pink'] = 'różowa skórka',
  ['tint_army'] = 'wojskowa skórka',
  ['tint_lspd'] = 'niebieska skórka',
  ['tint_orange'] = 'pomarańczowa skórka',
  ['tint_platinum'] = 'platynowa skórka',
